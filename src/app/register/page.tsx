    ...
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] flex-col justify-center px-12 xl:px-20">
        ...
        <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
          Inizia a gestire il tuo
          <br />
          <span className="text-indigo-400">studio da oggi</span>
        </h1>
        <p className="text-lg text-slate-400 mb-12 max-w-lg leading-relaxed">
          Crea il tuo account e accedi a tutti gli strumenti professionali per la gestione del tuo studio geometri.
        </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/10 p-8">
            <div className="mb-6">
              ...
              <p className="text-slate-500 mt-1 text-sm">Compila i campi per iniziare a usare GeoGest</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="block w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm text-slate-900 transition-all duration-200 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 appearance-none"
